...
{ src: appInsights, alt: "AI Insights" },
{ src: appInsightDetail, alt: "Insight Detail" },
{ src: appRiskHour, alt: "Risk Hour Detail" },
{ src: appCalendar, alt: "Calendar Integration" },
{ src: appTypicalDay, alt: "Typical Day Heatmap" }];
