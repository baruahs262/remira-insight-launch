  ...
  return (
    <section id="features" className="section-padding">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-primary font-display font-medium tracking-widest uppercase text-sm mb-3">Features</p>
          <h2 className="text-4xl md:text-5xl font-display font-bold mb-4">
            More than just <span className="text-gradient">charts</span>
          </h2>
