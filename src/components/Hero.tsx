    ...
    <section className="relative min-h-screen flex items-center justify-center section-padding pt-32 overflow-hidden text-secondary">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center text-primary">
        ...
        <motion.h1
          ...
          <span className="text-gradient text-blue-600">Made for Type-1 Diabetics</span>
          <br />
          <span className="text-gradient text-blue-600 text-2xl md:text-4xl lg:text-3xl">Your AI-Powered Glucose Companion</span>
        </motion.h1>
